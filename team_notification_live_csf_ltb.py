...
schema_name = 'fops'
redshift_table = 'live_csf_archive_ltb'
...
try:
    csf_df = live_csf_helper_ltb.extract_oracle_data()
    s3_file_path,aws_access_key_id,aws_secret_access_key,aws_session_token = live_csf_helper_ltb.load_data_s3(csf_df,region_name,bucket_name,schema_name,redshift_table,role_arn,aws_access_key,aws_secret_key,db_username,db_password,db_host,db_port,db_name)
    live_csf_helper_ltb.load_data_s3_to_redshift(s3_file_path,schema_name,redshift_table,bucket_name,aws_access_key_id,aws_secret_access_key,aws_session_token,region_name,db_host,db_name,db_port,db_username,db_password)
